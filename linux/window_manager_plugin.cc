#include "include/window_manager_clone/window_manager_clone_plugin.h"

#include <flutter_linux/flutter_linux.h>
#include <gtk/gtk.h>

#define WINDOW_MANAGER_CLONE_PLUGIN(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), window_manager_clone_plugin_get_type(), \
                              WindowManagerClonePlugin))

struct _WindowManagerClonePlugin {
...
G_DEFINE_TYPE(WindowManagerClonePlugin, window_manager_clone_plugin, g_object_get_type())

// Gets the window being controlled.
GtkWindow* get_window(WindowManagerClonePlugin* self) {
...
GdkWindow* get_gdk_window(WindowManagerClonePlugin* self) {
  return gtk_widget_get_window(GTK_WIDGET(get_window(self)));
}

static FlMethodResponse* set_as_frameless(WindowManagerClonePlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* destroy(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* close(WindowManagerClonePlugin* self) {
  gtk_window_close(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_prevent_close(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_prevent_close);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_prevent_close(WindowManagerClonePlugin* self,
                                           FlValue* args) {
...
static FlMethodResponse* focus(WindowManagerClonePlugin* self) {
  gtk_window_present(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* blur(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_focused(WindowManagerClonePlugin* self) {
  bool is_focused = gtk_window_is_active(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_focused);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* show(WindowManagerClonePlugin* self) {
  gtk_widget_show(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* hide(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* is_visible(WindowManagerClonePlugin* self) {
  bool is_visible = gtk_widget_is_visible(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_bool(is_visible);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_maximized(WindowManagerClonePlugin* self) {
  bool is_maximized = gtk_window_is_maximized(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_maximized);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* maximize(WindowManagerClonePlugin* self) {
  gtk_window_maximize(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* unmaximize(WindowManagerClonePlugin* self) {
  gtk_window_unmaximize(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_minimized(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* minimize(WindowManagerClonePlugin* self) {
  gtk_window_iconify(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_dockable(WindowManagerClonePlugin* self) {
  bool is_docked = false;
  g_autoptr(FlValue) result = fl_value_new_bool(is_docked);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_docked(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_null();
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* dock(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* undock(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* restore(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* is_full_screen(WindowManagerClonePlugin* self) {
  GdkWindowState state = gdk_window_get_state(get_gdk_window(self));
  g_autoptr(FlValue) result =
...
static FlMethodResponse* set_full_screen(WindowManagerClonePlugin* self,
                                         FlValue* args) {
  bool is_full_screen =
...
static FlMethodResponse* set_aspect_ratio(WindowManagerClonePlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_background_color(WindowManagerClonePlugin* self,
                                              FlValue* args) {
  GdkRGBA rgba;
...
static FlMethodResponse* get_bounds(WindowManagerClonePlugin* self) {
  gint x, y, width, height;
  gtk_window_get_position(get_window(self), &x, &y);
  gtk_window_get_size(get_window(self), &width, &height);
...
static FlMethodResponse* set_bounds(WindowManagerClonePlugin* self, FlValue* args) {
...
static FlMethodResponse* set_minimum_size(WindowManagerClonePlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_maximum_size(WindowManagerClonePlugin* self,
                                          FlValue* args) {
  const float width = fl_value_get_float(fl_value_lookup_string(args, "width"));
  const float height =
      fl_value_get_float(fl_value_lookup_string(args, "height"));
...
static FlMethodResponse* is_resizable(WindowManagerClonePlugin* self) {
  bool is_resizable = gtk_window_get_resizable(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_resizable);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_resizable(WindowManagerClonePlugin* self,
                                       FlValue* args) {
  bool is_resizable =
...
static FlMethodResponse* is_minimizable(WindowManagerClonePlugin* self) {
  GdkWindowState state = gdk_window_get_state(get_gdk_window(self));
...
static FlMethodResponse* set_minimizable(WindowManagerClonePlugin* self,
                                         FlValue* args) {
...
static FlMethodResponse* is_maximizable(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* set_maximizable(WindowManagerClonePlugin* self,
                                         FlValue* args) {
...
static FlMethodResponse* is_closable(WindowManagerClonePlugin* self) {
  bool is_closable = gtk_window_get_deletable(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_closable);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_closable(WindowManagerClonePlugin* self,
                                      FlValue* args) {
  bool is_closable =
...
static FlMethodResponse* is_always_on_top(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_always_on_top);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_always_on_top(WindowManagerClonePlugin* self,
                                           FlValue* args) {
  bool isAlwaysOnTop =
...
static FlMethodResponse* is_always_on_bottom(WindowManagerClonePlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_always_on_bottom);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_always_on_bottom(WindowManagerClonePlugin* self,
                                              FlValue* args) {
...
static FlMethodResponse* get_title(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* set_title(WindowManagerClonePlugin* self, FlValue* args) {
  const gchar* title =
...
static FlMethodResponse* set_title_bar_style(WindowManagerClonePlugin* self,
                                             FlValue* args) {
...
static FlMethodResponse* get_title_bar_height(WindowManagerClonePlugin* self,
                                              FlValue* args) {
...
static FlMethodResponse* is_skip_taskbar(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* set_skip_taskbar(WindowManagerClonePlugin* self,
                                          FlValue* args) {
  bool isSkipTaskbar =
...
static FlMethodResponse* set_icon(WindowManagerClonePlugin* self, FlValue* args) {
...
static FlMethodResponse* get_opacity(WindowManagerClonePlugin* self) {
  gdouble opacity = gtk_widget_get_opacity(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_float(opacity);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_opacity(WindowManagerClonePlugin* self, FlValue* args) {
...
static FlMethodResponse* pop_up_window_menu(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* start_dragging(WindowManagerClonePlugin* self) {
...
static void find_event_box(WindowManagerClonePlugin* plugin, GtkWidget* widget) {
  GList* children = NULL;
...
static FlMethodResponse* start_resizing(WindowManagerClonePlugin* self,
                                        FlValue* args) {
...
static GdkGrabStatus gdk_grab_keyboard(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* grab_keyboard(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* ungrab_keyboard(WindowManagerClonePlugin* self) {
...
static FlMethodResponse* set_brightness(WindowManagerClonePlugin* self,
                                        FlValue* args) {
...
static void window_manager_clone_plugin_dispose(GObject* object) {
  WindowManagerClonePlugin* self = window_manager_clone_plugin(object);
...
static void window_manager_clone_plugin_init(WindowManagerClonePlugin* self) {}

static void method_call_cb(FlMethodChannel* channel,
                           FlMethodCall* method_call,
                           gpointer user_data) {
  WindowManagerClonePlugin* plugin = window_manager_clone_plugin(user_data);
  window_manager_clone_plugin_handle_method_call(plugin, method_call);
}

void _emit_event(WindowManagerClonePlugin* plugin, const char* event_name) {
  g_autoptr(FlValue) result_data = fl_value_new_map();
...
gboolean on_window_close(GtkWidget* widget, GdkEvent* event, gpointer data) {
  WindowManagerClonePlugin* plugin = window_manager_clone_plugin(data);
...
void emit_button_release(WindowManagerClonePlugin* self) {
...
void window_manager_clone_plugin_register_with_registrar(
    FlPluginRegistrar* registrar) {
  WindowManagerClonePlugin* plugin = window_manager_clone_plugin(
  ...
  plugin->channel =
      fl_method_channel_new(fl_plugin_registrar_get_messenger(registrar),
                            "window_manager_clone", FL_METHOD_CODEC(codec));
