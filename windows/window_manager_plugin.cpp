...
class WindowManagerClonePlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows* registrar);

  WindowManagerClonePlugin(flutter::PluginRegistrarWindows* registrar);

  virtual ~WindowManagerClonePlugin();
 ...
 private:
  ...
  void WindowManagerClonePlugin::_EmitEvent(std::string eventName);
  // Called for top-level WindowProc delegation.
  std::optional<LRESULT> WindowManagerClonePlugin::HandleWindowProc(HWND hWnd,
                                                               UINT message,
                                                               WPARAM wParam,
                                                               LPARAM lParam);
...
// static
void WindowManagerClonePlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows* registrar) {
  channel = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
      registrar->messenger(), "window_manager_clone",
      &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<WindowManagerClonePlugin>(registrar);
...
WindowManagerClonePlugin::WindowManagerClonePlugin(
    flutter::PluginRegistrarWindows* registrar)
    : registrar(registrar) {
...
void WindowManagerClonePlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue>& method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void WindowManagerClonePluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  WindowManagerClonePlugin::RegisterWithRegistrar(
